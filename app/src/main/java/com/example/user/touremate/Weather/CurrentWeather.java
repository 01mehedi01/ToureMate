...
public class CurrentWeather extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_current_weather2, container, false);
        ...
        endUrl = String.format("weather?lat=%f&lon=%f&units=%s&appid=%s",
        ...
        call.enqueue(new Callback<CurrentWeatherResponse>() {
            ...
            public void onResponse(Call<CurrentWeatherResponse> call, Response<CurrentWeatherResponse> response) {
                if(response.code() == 200){
                    ...
                    temp.setText(nn+WeatherActivity.tempSign);
                    ...
                    minTemp.setText(minTmp+WeatherActivity.tempSign);

                    String maxTmp = currentWeatherResponse.getMain().getTempMax().toString();
                    maxTemp.setText(maxTmp+WeatherActivity.tempSign);
